...
1. There are many useful extensions, for example `hx-sse.js` for Server-Sent Events and `hx-preload.js` for faster navigation. Suggest them if they make sense.
